# Guia de Desenvolvimento Frontend - ViralKids

## 🚀 Início Rápido

### Pré-requisitos
- Node.js 18+ 
- pnpm (preferencial) ou yarn
- Git
...
│   └── suppliers/   # Sistema de fornecedores
├── hooks/           # Hooks customizados e wrappers
├── lib/             # Utilitários e configurações
├── pages/           # Páginas da aplicação
│   ├── Ecommerce/   # Páginas do e-commerce
│   └── ProductDetail/ # Páginas de detalhes
├── providers/       # Providers da aplicação
├── router/          # Configuração de rotas
├── services/        # Serviços e APIs
│   ├── api/         # Cliente HTTP e configurações
│   ├── auth/        # Serviços de autenticação
│   ├── chatbot/     # Serviços de chatbot
│   ├── franchise/   # Serviços de franquia
...
- [ ] Estado é gerenciado corretamente (Zustand vs React Query)
- [ ] Componentes seguem o padrão de estrutura definido
- [ ] Estilos usam o design system (Tailwind + shadcn/ui)
- [ ] Serviços seguem o padrão de API definido
- [ ] Hooks customizados são reutilizáveis
