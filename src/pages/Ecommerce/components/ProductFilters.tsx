          ...
          {brands.map((brand) => (
            <label key={brand} className="flex items-center">
              <input
                ...
                className="mr-2"
              />
              <span className="text-base text-gray-600">{brand}</span>
            </label>
          ))}
        </div>
      </div>
        ...
        <div className="space-y-2">
          <label className="flex items-center">
            <input
              ...
              className="mr-2"
            />
            <span className="text-base text-gray-600">Apenas em estoque</span>
          </label>
          ...
          <label className="flex items-center">
            <input
              ...
              className="mr-2"
            />
            <span className="text-base text-gray-600">Produtos novos</span>
          </label>
          ...
          <label className="flex items-center">
            <input
              ...
              className="mr-2"
            />
            <span className="text-base text-gray-600">Em destaque</span>
          </label>
        </div>
      </div>
    </div>
