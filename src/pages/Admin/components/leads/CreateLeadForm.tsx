...
const leadSchema = z.object({
  ...
  // Step 3: Opções
  convertToCustomer: z.boolean().default(false),
});
...
export function CreateLeadForm({ onSuccess, onCancel }: CreateLeadFormProps) {
          ...
          <div className='space-y-4'>
            ...
            <div>
              ...
              <p className='text-sm text-muted-foreground mt-1'>
                Pontuação de qualificação do lead (0-100)
              </p>
            </div>
  ...
  return (
    <Card className='w-full max-w-4xl mx-auto'>
      <CardHeader>
        <CardTitle className='text-2xl'>Criar Novo Lead</CardTitle>
        <CardDescription>
          Complete as etapas abaixo para adicionar um novo lead ao funil de vendas
        </CardDescription>
